...
#play button image
play_button = pygame.image.load(get_asset_path("assets/play.png")).convert_alpha()
play_button = pygame.transform.smoothscale(play_button,(400,200))

#settings button image
settings_button = pygame.image.load(get_asset_path("assets/settings.png")).convert_alpha()
settings_button = pygame.transform.smoothscale(settings_button,(210,200))

#about button image
about_button = pygame.image.load(get_asset_path("assets/about.png")).convert_alpha()
about_button = pygame.transform.smoothscale(about_button,(200,200))

#how to play button image
how_to_play_button = pygame.image.load(get_asset_path("assets/howtoplay.png")).convert_alpha()
how_to_play_button = pygame.transform.smoothscale(how_to_play_button,(400,200))

#quit button image
quit_button = pygame.image.load(get_asset_path("assets/quit.png")).convert_alpha()
